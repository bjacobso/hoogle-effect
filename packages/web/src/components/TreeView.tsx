  ...
  return (
    <div>
      ...
      >
        ...
        <span className="text-xs px-1.5 py-0.5 bg-gray-100 text-gray-600 rounded-full ml-auto">
          {node.count}
        </span>
      </button>
  ...
  return (
    <div>
      ...
      >
        ...
        <span className="text-xs px-1.5 py-0.5 bg-purple-100 text-purple-700 rounded-full ml-auto">
          {node.count}
        </span>
      </button>
...
function FunctionNode({
  ...
  return (
    <button
      ...
      className={`w-full text-left px-3 py-2 border-b border-gray-100 transition-all ${
        isSelected
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <span className={`font-mono text-sm ${isSelected ? 'text-purple-700' : 'text-gray-700'}`}>
          {func.name}
        </span>
        {func.deprecated && (
      ...
      <div className="ml-5 mt-1 text-xs text-gray-500 font-mono truncate">
