    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
      ...
      <div className="p-6 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
        <div className="flex items-center gap-2 mb-2">
          <span className="text-lg text-gray-600 dark:text-gray-400">{func.module}</span>
          <span className="text-gray-400 dark:text-gray-500">.</span>
          <span className="text-xl font-bold text-purple-600 dark:text-purple-400">{func.name}</span>
        </div>
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          ...
          {func.deprecated && (
            <span className="text-xs px-2 py-1 bg-red-100 dark:bg-red-900/50 text-red-700 dark:text-red-400 rounded-full">
              deprecated
            </span>
          )}
        </div>
        ...
        <div className="p-6 border-b border-gray-100 dark:border-gray-700">
          ...
          <div className="space-y-4">
            {func.examples.map((example, i) => (
              <div key={i}>
                {example.title && (
                  <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{example.title}</p>
                )}
      ...
      <div className="p-6 bg-gray-50 dark:bg-gray-800/50 border-b border-gray-100 dark:border-gray-700">
        ...
        <div className="flex items-center gap-2">
          <code className="flex-1 text-sm bg-gray-100 dark:bg-gray-700 px-3 py-2 rounded font-mono text-gray-700 dark:text-gray-300">
          ...
          <button
            ...
            className="px-3 py-2 text-sm bg-purple-100 dark:bg-purple-900/50 text-purple-700 dark:text-purple-300 rounded hover:bg-purple-200 dark:hover:bg-purple-900/70 transition-colors"
          >
            Copy
          </button>
        </div>
